...
And in fact, the cycles are critical in understanding the dynamics of symptoms.
...
But unfortunately it is not so straightforward to estimate a cyclic model, since relaxing the acyclicity assumption comes with a lot theoretical complication.
