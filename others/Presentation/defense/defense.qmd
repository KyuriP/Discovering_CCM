...
So overall, it is not so straightforward which algorithm is the best. It is somewhat dependent on the situations.
...
But, given our simulation study, our conclusion is rather nuanced. We believe that there is no single algorithm that does well across all scenarios. Researchers hence must consider the characteristics of the causal system of interest when choosing an algorithm. 
...
::: notes
That was in a nutshell, what I've been working on for the next few more weeks. Here are the references. Are there any questions? Anything unclear? 
:::
...
-   [[*Global Markov property*]{style="color:#cc0000"} is no longer guaranteed.]{style="font-size: 0.85em"}
    -   [Need extra restrictions on $P$. <br> (e.g., linear relations with independent error terms ($\varepsilon$))]{style="font-size: 0.7em"}


-   [Cyclic model is [not always *statistically identified*]{style="color:#cc0000"}.]{style="font-size: 0.85em"}
    -   [many equivalent models ! $\rightarrow$ PAG (partial ancestral graph).]{style="font-size: 0.7em"}


-   [[*Equilibrium*]{.highlight-red} *state* is necessary ([All $|\lambda| < 1$]{style="color:#cc0000"})]{style="font-size: 0.85em"}.
