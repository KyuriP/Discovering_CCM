...
::: notes
Despite all that, there has been some solutions suggested in the past called CCD, cyclic causal discovery method. FCI, fast causal inference method. And CCI, cyclic causal inference method. So these are three algorithms that can estimate the cyclic causal models.
:::
