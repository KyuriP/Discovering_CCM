...
SHDs %>%
  ...
  # geom_ribbon(aes(ymin=quantile(means)[2], ymax=quantile(means)[4]), alpha=0.2, color=NA) +
  # geom_errorbar(aes(ymin=quantile(means)[2], ymax = quantile(means)[4]), width=0.1, alpha=0.3) +
