...
- confusion matrix do we wanna add the column/row of circle and shade that?
...
- Make defense slides
- READEME on how to reproduce: has to be cleaned up. and better phrasing.
- README: especially manuscript folder needs to be updated when the manuscript is finalized.

 
## phrasing
- Data generation: N(0,1) or just say "standard normal random variables"
- "until they level off" ?.. (sensitivity analyses)